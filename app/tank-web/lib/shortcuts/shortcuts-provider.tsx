...
export function useShortcutsContext(): ShortcutsContextValue | null {
  // 不抛错 ── 某些组件 (slash menu 这种) 通过 imperative React root 挂到
  // document.body, 不在 <ShortcutsProvider> 子树里。调用方 (ShortcutKbd /
  // useShortcutScope) 自己判 null 走 fallback, 而不是把整条 layout effect
  // 链炸掉。
